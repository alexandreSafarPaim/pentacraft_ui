...
import { BiSolidTagAlt, BiChevronUp, BiChevronDown, BiSearchAlt } from 'react-icons/bi';
...
function PCLayoutHeaderMenu(_ref) {
  ...
  }, userName ? returnInitials(userName) : userImage ? React.createElement("img", {
    src: userImage,
    alt: "Profile",
    className: "h-full"
...
var PCLayoutMenu = function PCLayoutMenu(_ref) {
  ...
  }, menuItems), endItens && React.createElement("div", {
...
var PCLayoutList = function PCLayoutList(_ref) {
  ...
  return React.createElement("div", {
    ...
    className: "text-3xl font-bold mb-2"
  }, title), createButtonTitle && React.createElement(NewButton, {
...
export { Button, CustomSelect, Form, Input, Layout, List, NavigationButton, Switcher, Table, capitalizeName, childrenWithout, defineAllChildrenElement, defineChildrenElement, formatColor, isComponent, returnInitials };
