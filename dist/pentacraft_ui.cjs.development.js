...
var NavigationButton = function NavigationButton(_ref) {
  ...
  if (!href) {
    ...
    return React__default.createElement(Link, {
      href: href != null ? href : '#',
      className: tailwindMerge.twMerge("flex items-center h-8 text-left w-full px-4 hover:text-white hover:bg-slate-900", className),
      style: _extends({
        transition: 'background-color 0.3s ease-in-out'
      }, style)
    }, children);
...
function PCLayoutHeaderMenu(_ref) {
  ...
  if (customAvatar) {
    return React__default.createElement(React__default.Fragment, null, customAvatar({
      userName: userName,
      userImage: userImage
    }));
  }
...
var PCLayoutTD = function PCLayoutTD(_ref) {
  ...
  return React__default.createElement("td", Object.assign({
    className: tailwindMerge.twMerge('p-4 border-b border-blue-gray-50', className)
  }, props), children);
};
...
var PCLayoutList = function PCLayoutList(_ref) {
  ...
  }, actions == null ? void 0 : actions(), createButtonTitle && React__default.createElement(NewButton, {
  ...
  }, renderPreList == null ? void 0 : renderPreList(), React__default.createElement("div", {
    className: "w-full h-full"
...
var PCLayoutPage = function PCLayoutPage(_ref) {
  ...
  }, actions == null ? void 0 : actions())), React__default.createElement("div", null, filters), React__default.createElement("div", {
    className: " w-full flex flex-col flex-1 "
  }, React__default.createElement("div", {
    className: "w-full flex-1"
  }, content), React__default.createElement("div", null, pagination)));
};
var Page = {
  Root: PCLayoutPage,
...
exports.Filters = PCLayoutFilters;
exports.Form = Form;
exports.Input = Input;
...
exports.Page = Page;
exports.Pagination = PCLayoutPagination;
